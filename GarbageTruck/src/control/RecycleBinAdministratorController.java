 ...
 * @version 1.0
 */
public class RecycleBinAdministratorController extends RecycleBinAdministrator {

    /**
     * Refere-se a instância singular do controlador de lixeira.
     */
    private static RecycleBinAdministratorController instance;
    /**
     ...
     */
    private RecycleBinAdministratorController() {
     ...
     */
    public static RecycleBinAdministratorController getInstance() {
        if (instance == null) {
            instance = new RecycleBinAdministratorController();
        }
        return instance;
    }
